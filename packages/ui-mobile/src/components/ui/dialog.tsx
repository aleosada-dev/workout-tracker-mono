      ...
      <DialogOverlay>
        ...
        >
          ...
          >
            <Icon
              as={X}
              className={cn('web:pointer-events-none size-4 shrink-0 text-accent-foreground')}
            />
...
function DialogTitle({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Title>) {
  return (
    <DialogPrimitive.Title
      className={cn('font-sans-semibold text-foreground text-lg leading-none', className)}
      {...props}
    />
  );
}
