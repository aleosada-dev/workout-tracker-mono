...
function SelectValue({
  ...
  return (
    <SelectPrimitive.Value
      ref={ref}
      className={cn(
        'line-clamp-1 flex flex-row items-center gap-2 font-sans text-foreground text-sm',
...
function SelectLabel({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.Label>) {
  return (
    <SelectPrimitive.Label
      className={cn('px-2 py-2 font-sans text-muted-foreground text-xs sm:py-1.5', className)}
      {...props}
    />
  );
}
...
function SelectItem({
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.ItemText className="select-none font-sans text-foreground text-sm group-active:text-accent-foreground" />
    </SelectPrimitive.Item>
  );
}
