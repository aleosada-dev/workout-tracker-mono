...
export const toExerciseDetail = async (
  ...
  return {
    ...
    records: {
      ...
      maxTotalDurationSeconds: raw.records.max_total_duration_seconds,
      maxTotalDistanceMeters: raw.records.max_total_distance_meters,
      maxTotalReps: raw.records.max_total_reps,
    },
  };
};
