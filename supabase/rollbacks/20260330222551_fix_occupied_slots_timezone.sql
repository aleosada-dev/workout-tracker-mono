-- Rollback: restore original get_coach_occupied_slots without timezone parameter
...
-- Drop the overloaded version with 4 parameters
DROP FUNCTION IF EXISTS public.get_coach_occupied_slots(uuid, date, date, text);
