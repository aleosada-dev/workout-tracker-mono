-- Rollback: remove muscle_id and muscle_name from get_workout RPC exercises
-- Restores the version from 20260405141652 (with video_url but without muscle fields)
