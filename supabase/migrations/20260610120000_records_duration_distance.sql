-- ----------------------------------------------------------------------------
-- Tier B de PRs por measurement type: além de peso/reps/volume/sets, passamos a
-- persistir o melhor set de duração e de distância por variação. Os exercícios
...
-- também levando o melhor set de duração e distância (geral + por alias).
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- wt_get_exercise_history: por sessão passa a projetar também o melhor set de
-- duração/distância e esses campos por set; o objeto records expõe os dois novos
-- recordes. Assinatura inalterada — CREATE OR REPLACE.
-- ----------------------------------------------------------------------------
