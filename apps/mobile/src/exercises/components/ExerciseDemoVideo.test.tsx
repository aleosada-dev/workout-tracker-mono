...
import { ExerciseDemoVideo } from '@/exercises/components/ExerciseDemoVideo';
...
jest.mock('@/exercises/components/ExerciseVideoCard', () => ({
  ExerciseVideoCard: ({ uri }: { uri: string }) => {
    const { Text } = require('react-native');
    return <Text testID="exercise-detail.video.mp4">{uri}</Text>;
  },
}));
jest.mock('@/exercises/components/ExerciseYouTubeCard', () => ({
