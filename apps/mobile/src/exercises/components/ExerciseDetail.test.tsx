...
import { getMockExerciseDetail } from '@/exercises/lib/detail-mock';
import type { ExerciseDetailData } from '@/exercises/lib/detail-types';
...
jest.mock('@/exercises/components/ExerciseMetricChart', () => ({
  ExerciseMetricChart: () => null,
}));
jest.mock('@/exercises/components/ExerciseDemoVideo', () => ({
  ExerciseDemoVideo: () => null,
}));
jest.mock('@/exercises/components/SetTypesHelpDialog', () => {
